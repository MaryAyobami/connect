...
function StudentLogin() {
 ...
 const handleLogin = async(e)=>{
   e.preventDefault()
   await Axios.post('http://localhost:5000/api/login-student',
   {
     email,
    ...
    <div className='bg-cyan-700 bg- flex flex-row w-[70%] mx-auto ' >
      <section className='hidden lg:flex flex-1 p-8 text-gray-100 flex-col items-center justify-center'>
       <div className='flex flex-col justify-center items-center'>
        ...
        <p className='text-xl'>Login as a <a href="/login/staff" className='text-blue-300 underline'>STAFF</a> or <a href="/login/student" className='text-blue-300 underline'>STUDENT</a></p>
       </div>
       <div className='absolute top-[75%] text-white'>
        New Member? <a href="/register/student" className='text-blue-300 underline'>sign up here</a>
       </div>
      </section>
